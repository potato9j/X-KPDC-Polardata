def bilinear_value(x, y, x0, x1, y0, y1, q00, q10, q01, q11):
    """
    주변 4개 격자점(q00, q10, q01, q11)을 이용하여 특정 좌표(x, y)의 값을 이중 선형 보간
    """
    if x1 == x0 or y1 == y0:
        raise ValueError('Degenerate bilinear support (면적이 없는 동일 좌표)')
...
#     # x: 0.5, y: 0.5 위치에서의 보간 (4개 코너 값이 각각 10, 20, 30, 40일 때)
#     val = bilinear_value(0.5, 0.5, 0.0, 1.0, 0.0, 1.0, 10, 20, 30, 40)
#     print(f"Bilinear Interpolated Value: {val}") # 예상값: 25.0
